...
import { AuthenticationPage, buttons, shadows, colors, colorsRaw, lengths } from '../../ui'
...
export default class GitGatewayAuthenticationPage extends React.Component {
  ...
  render() {
    ...
    if (window.netlifyIdentity) {
      return (
        <AuthenticationPage onLogin={this.handleIdentity} renderButtonContent={() => 'Login with Netlify Identity'} />
      )
    }
