...
import { Cursor, CURSOR_COMPATIBILITY_SYMBOL } from '../utils'
...
class Backend {
  ...
  getEntry(collection, slug) {
    return this.implementation.getEntry(collection, slug, selectEntryPath(collection, slug)).then(loadedEntry =>
  ...
  filterEntries(collection, filterRule) {
    return collection.entries.filter(entry => entry.data[filterRule.get('field')] === filterRule.get('value'))
  }
}
