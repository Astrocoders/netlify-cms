...
export default class EditorToolbar extends React.Component {
  ...
  renderSimpleSaveControls = () => {
    ...
    return <div>{showDelete ? <DeleteButton onClick={onDelete}>Delete entry</DeleteButton> : null}</div>
  }
    ...
    return (
      <div>
        <ToolbarDropdown
          ...
          dropdownWidth="150px"
          renderButton={() => <PublishButton>{isPersisting ? 'Publishing...' : 'Publish'}</PublishButton>}
        >
      ...
      return (
        <>
          <ToolbarDropdown
            dropdownTopOverlap="40px"
            dropdownWidth="120px"
            renderButton={() => <StatusButton>{isUpdatingStatus ? 'Updating...' : 'Set status'}</StatusButton>}
          >
            <StatusDropdownItem
              label="Draft"
          ...
          <ToolbarDropdown
            dropdownTopOverlap="40px"
            dropdownWidth="150px"
            renderButton={() => <PublishButton>{isPublishing ? 'Publishing...' : 'Publish'}</PublishButton>}
          >
